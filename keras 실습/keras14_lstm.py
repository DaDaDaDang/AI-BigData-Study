...
# 모델 구성하기 - LSTM 여러개 붙인다고 무조건 좋은게 아니다 데이터양에 맞는 적절한 LSTM이 필요하다. (과적합(overfit)되었다)
# LSTM의 적절한 모델을 구성하는 것이 핵심
# LSTM을 여러개 붙여 layer을 만들려면 return_sequences=True를 뒤에 붙여야 한다.
